...
export default function POSLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 p-4">
      ...
      <div className="relative bg-white/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border border-orange-200">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-white border-2 border-gray-300 text-gray-900 rounded-xl focus:border-orange-500 focus:outline-none transition-colors placeholder-gray-400"
                required
              />
            </div>
