      ...
      <div className="bg-white/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md border-2 border-orange-200 animate-scaleIn">
        <form onSubmit={handleLogin} className="space-y-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Access your POS system</p>
          </div>

          {error && (
            <div className="p-4 bg-red-50 border-2 border-red-500 rounded-2xl flex items-center gap-3 text-red-700 animate-shake">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:border-orange-500 focus:outline-none transition-colors"
                required
              />
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-orange-500 to-red-600 text-white py-3 rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <div className="text-center pt-4">
            <p className="text-gray-600">
              ...
              <Link href="/pos/register" className="text-orange-600 font-semibold hover:text-orange-700">
                Register here
              </Link>
            </p>
          </div>
