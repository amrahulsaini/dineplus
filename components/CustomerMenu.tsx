        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={logout}
                className="px-4 py-2.5 bg-[#242424] hover:bg-[#2a2a2a] text-cream-300 border border-cream-700/30 rounded-2xl transition-all duration-300 flex items-center gap-2 font-semibold hover:shadow-lg transform hover:scale-105"
              >
